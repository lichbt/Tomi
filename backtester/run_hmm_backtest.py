"""Multi-instrument backtest for HMM Regime Filter strategy."""
import sys
import os
import json
import numpy as np
...
def main():
    print("=" * 80)
    print("BACKTEST: HMM Regime Filter — Multi-Instrument H4")
    print("=" * 80)
    ...
    out_path = out_dir / f"hmm_regime_multi_instrument_{timestamp}.json"
    out_path.write_text(json.dumps(output, indent=2))

    stable_path = out_dir / "hmm_regime_multi_instrument.json"
